...
?>
<title>Programs - <?php echo $company_name; ?>, Siem Reap, Cambodia</title>
</head>
        ...
        <div class="w-full lg:w-[1200px] m-0 lg:m-auto">
            <div class="flex items-center py-16">
                <div class="w-full">
                        ...
                        <?php
                        $sp = "SELECT * FROM services_and_programs WHERE category_list = 'Programs'";
                            ...
                            while ($sp_data = $sp_result->fetch_assoc()) {
                                ...
                                <div class="flex justify-center  rounded-md shadow-lg">
                                    <div class="h-full relative">
                                        ...
                                        <div class="p-8">
                                            <h2 class="text-center text-xl font-semibold mb-4 uppercase">
                                                <?php echo $sp_name; ?>
                                            </h2>
